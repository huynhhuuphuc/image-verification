  ...
  return (
    <Router>
      <div className="main-layout bg-gray-50">
        {/* Mobile overlay */}
        {isSidebarOpen && (
          <div className="mobile-overlay sm:hidden" onClick={closeSidebar} />
        )}
        ...
        <main className="main-content">
          <Routes>
            ...
            <Route
              path="/products"
              element={<ProductListScreen onToggleSidebar={toggleSidebar} />}
            />
            <Route
              path="/products/add"
              element={<AddProductScreen onToggleSidebar={toggleSidebar} />}
            />
            <Route
              path="/products/:id"
              element={<ProductDetailScreen onToggleSidebar={toggleSidebar} />}
            />
            <Route
              path="/employees"
              element={
                <EmployeeManagementScreen onToggleSidebar={toggleSidebar} />
              }
            />
          </Routes>
        </main>
